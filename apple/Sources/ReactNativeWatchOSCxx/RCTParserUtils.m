// Copy of upstream `react-native/React/Base/RCTParserUtils.m` (v0.81.5).
// Only change: `#import "…"` → `#import <React/…>` so the .m picks up
// our forked `<React/RCTLog.h>` instead of upstream's (which pulls
// `RCTAssert.h` / `RCTUtils.h` we don't ship).
/*
